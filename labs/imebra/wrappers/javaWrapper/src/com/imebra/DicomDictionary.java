...
public class DicomDictionary {
  ...
  public static SWIGTYPE_p_std__wstring getUnicodeTagName(TagId id) {
    return new SWIGTYPE_p_std__wstring(imebraJNI.DicomDictionary_getUnicodeTagName(TagId.getCPtr(id), id), true);
  }
