...
public class AssociationBase {
  ...
  public AssociationMessage getCommand() {
    long cPtr = imebraJNI.AssociationBase_getCommand(swigCPtr, this);
    return (cPtr == 0) ? null : new AssociationMessage(cPtr, true);
  }

  public AssociationMessage getResponse(int messageId) {
    long cPtr = imebraJNI.AssociationBase_getResponse(swigCPtr, this, messageId);
    return (cPtr == 0) ? null : new AssociationMessage(cPtr, true);
  }
