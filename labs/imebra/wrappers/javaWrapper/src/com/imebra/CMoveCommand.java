...
public class CMoveCommand extends DimseCommand {
  ...
  public CMoveCommand(String abstractSyntax, int messageID, dimseCommandPriority_t priority, String affectedSopClassUid, DataSet identifier) {
    this(imebraJNI.new_CMoveCommand__SWIG_0(abstractSyntax, messageID, priority.swigValue(), affectedSopClassUid, DataSet.getCPtr(identifier), identifier), true);
  }
  ...
  public CMoveCommand(String abstractSyntax, int messageID, dimseCommandPriority_t priority, String affectedSopClassUid, String destinationAET, DataSet identifier) {
    this(imebraJNI.new_CMoveCommand__SWIG_1(abstractSyntax, messageID, priority.swigValue(), affectedSopClassUid, destinationAET, DataSet.getCPtr(identifier), identifier), true);
  }
